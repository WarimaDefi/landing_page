    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          {assets.map((asset, index) => (
            ...
            >
              ...
              <div className="relative h-48 w-full overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 bg-tertiary text-tertiary-foreground px-3 py-1 rounded-full text-xs font-semibold shadow">
                  {asset.roi} ROI
                </div>
              </div>
